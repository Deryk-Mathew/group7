<div class="balances index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('cash_balance'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($balance['Balance']['cash_balance']); ?>&nbsp;</td>
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $balance['Balance']['id']), array(), __('Are you sure you want to delete # %s?', $balance['Balance']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
